  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        {/* Become Instructor Button / Greeting */}
    ...
    transition-all duration-200">
          ...
          {/* If NOT logged in → show clickable button */}
          {!token ? (
            <Link to="/signup">
          ...
          transition-all duration-200 hover:scale-95 hover:bg-richblack-900">
            ...
            /* If logged in → greet user (unclickable) */
            <div className="flex flex-row items-center gap-2 rounded-full px-10 py-[5px] 
        cursor-default bg-richblack-800 text-richblack-100">
